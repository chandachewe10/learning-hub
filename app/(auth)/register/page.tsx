...
function RegisterForm() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      if (signInResult?.ok) {
        router.push(data.role === "INSTRUCTOR" ? "/instructor/dashboard" : "/student/dashboard");
      } else {
        setSuccess(true);
      }
    } catch {
  ...
  if (success) {
    return (
      <Card className="w-full max-w-md bg-white/10 backdrop-blur-xl border-white/20 text-center p-8">
        ...
        <Link href="/login">
          <Button variant="gradient" className="w-full">Sign In Now</Button>
        </Link>
      </Card>
    );
  }
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          {([
            ...
            { value: "INSTRUCTOR", label: "Instructor", icon: GraduationCap, desc: "I want to teach" },
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-9 bg-white/10 border-white/20 text-white placeholder:text-slate-400 focus-visible:ring-indigo-400"
              />
            </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-9 pr-9 bg-white/10 border-white/20 text-white placeholder:text-slate-400 focus-visible:ring-indigo-400"
              />
              <button
                type="button"
          ...
          <Button type="submit" className="w-full" variant="gradient" size="lg" loading={isSubmitting}>
